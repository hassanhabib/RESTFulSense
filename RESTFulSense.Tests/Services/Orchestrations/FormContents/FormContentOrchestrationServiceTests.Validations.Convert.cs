...
namespace RESTFulSense.Tests.Services.Orchestrations.FormContents
{
    public partial class FormContentOrchestrationServiceTests
    {
        ...
        [Fact]
        public void ShouldThrowFormContentOrchestrationDependencyValidationExceptionIfFileNameProcessingDependencyValidationExceptionOccurs()
        {
            // given
            Object someObject = CreateSomeObject();
            Object inputObject = someObject;
            ...
            var fileNameProcessingDependencyValidationException =
                new FileNameProcessingDependencyValidationException(nullObjectException);

            var expectedFormContentOrchestrationDependencyValidationException =
                new FormContentOrchestrationDependencyValidationException(fileNameProcessingDependencyValidationException);
            ...
            this.fileNameProcessingServiceMock.Setup(service =>
                service.UpdateFileNames(It.IsAny<IEnumerable<NamedStreamContent>>(), returnedPropertyValues))
                    .Throws(fileNameProcessingDependencyValidationException);
